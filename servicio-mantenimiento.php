...
<section class="content__mantenimiento">
    <article class="container__matenimiento">
        <div class="items__mantenimiento">
            ...
            <a class="cta__mantenimiento" target="_blank" href="https://wa.link/vnbx5v">Consúltenos</a>
        </div>
        <figure class="figure__mantenimiento">
            <img src="./img/img-mantenimiento/mantenimiento.png"  alt="">
        </figure>
    </article>
</section>
